...
export const queryKeys = {
  ...
  admin: {
    ...
    users: {
      all: () => [...queryKeys.admin.all, 'users'],
      lists: () => [...queryKeys.admin.users.all(), 'list'],
      list: (filters) => [...queryKeys.admin.users.lists(), { filters }],
      details: () => [...queryKeys.admin.users.all(), 'detail'],
      detail: (id) => [...queryKeys.admin.users.details(), id],
    },
  },
};
